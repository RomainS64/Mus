...
public class Partie {
  ...
  public static class Score {
    ...
    public Score(Opposants opposants) {
      this.manchesGagneesParJoueur.put(opposants.getEquipe1().getJ1(), 0);
      this.manchesGagneesParJoueur.put(opposants.getEquipe1().getJ2(), 0);
      this.manchesGagneesParJoueur.put(opposants.getEquipe2().getJ1(), 0);
      this.manchesGagneesParJoueur.put(opposants.getEquipe2().getJ2(), 0);
